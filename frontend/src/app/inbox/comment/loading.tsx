...
export function InboxContentLoading() {
  return (
    <div className="h-[400px] bg-background-light dark:bg-background-dark">
      {[...Array(7)].map((_, index) => (
        <div key={index} className="p-2 border-b border-gray-200 dark:border-gray-700 flex items-start space-x-4">
